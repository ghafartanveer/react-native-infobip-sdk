...
struct CredentialsManager {
    enum Constants {
        static let usernameKey = "com.infobip.username"
        static let passwordKey = "com.infobip.password"
        static let deviceTokenKey = "com.infobip.deviceToken"
        static let certificateIdKey = "com.infobip.certificateId"
    }
